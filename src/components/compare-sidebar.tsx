...
export default function CompareSidebar() {
  const mockup_top10popular = [
    { rank: 1, image: 'images/uni-pic/kmutt.avif', detail: 'วิทยาการคอมพิวเตอร์ประยุกต์', addImage: 'images/uni-pic/add.avif' },
    { rank: 2, image: 'images/uni-pic/cu.avif', detail: 'คณะแพทยศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย', addImage: 'images/uni-pic/add.avif' },
    { rank: 3, image: 'images/uni-pic/cu.avif', detail: 'สาขา วิศวกรรมศาสตร์คอมพิวเตอร์', addImage: 'images/uni-pic/add.avif' },
    { rank: 4, image: 'images/uni-pic/tu.avif', detail: 'คณะนิติศาสตร์ มหาวิทยาลัยธรรมศาสตร์', addImage: 'images/uni-pic/add.avif' },
    { rank: 5, image: 'images/uni-pic/mu.avif', detail: 'คณะแพทยศาสตร์ศิริราชพยาบาล', addImage: 'images/uni-pic/add.avif' },
    { rank: 6, image: 'images/uni-pic/ku.avif', detail: 'คณะบริหารธุรกิจ การบัญชี', addImage: 'images/uni-pic/add.avif' },
    { rank: 7, image: 'images/uni-pic/swu.avif', detail: 'วิทยาลัยนวัตกรรม การจัดการการสื่อสาร', addImage: 'images/uni-pic/add.avif' },
    { rank: 8, image: 'images/uni-pic/cmu.avif', detail: 'คณะมนุษยศาสตร์ อักษรศาสตร์', addImage: 'images/uni-pic/add.avif' },
    { rank: 9, image: 'images/uni-pic/kku.avif', detail: 'สาขา วิศวกรรมศาสตร์คอมพิวเตอร์', addImage: 'images/uni-pic/add.avif' },
    { rank: 10, image: 'images/uni-pic/kmutnb.avif', detail: 'สาขา วิศวกรรมหุ่นยนต์', addImage: 'images/uni-pic/add.avif' }
  ];
  ...
  const sortedData = () => {
    ...
    if (sortOption === 'A-Z') {
      ...
      sortedList.sort((a, b) => a.rank - b.rank);
      ...
      <div className="ml-8 w-full flex flex-col py-4 items-start gap-6">
        ...
        <div className="w-[95%] flex self-start py-2 px-3 bg-monochrome-100 rounded-md divide-x divide-monochrome-600">
          ...
          <button className="w-auto flex items-center justify-center pl-2">
            <img
              src="/images/uni-pic/search.avif"
              alt="Search Icon"

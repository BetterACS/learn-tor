...
const CompareSidebar: React.FC<CompareSidebarProps> = ({
  ...
  const top10popular = universities.map((university, index) => ({
    rank: index + 1,
    logo: university.logo || '/images/logofooter.avif',
  ...
  return (
    <div>
      ...
      <div
        ...
        } w-full sm:w-full md:w-1/2 lg:w-1/4 h-screen bg-monochrome-50 p-4 transition-all duration-300 z-10`}
      >
            ...
            <div className="w-[95%] flex self-start py-2 px-3 bg-monochrome-100 rounded-md divide-x divide-monochrome-600">
              ...
              <button className="w-auto flex items-center justify-center pl-2">
                <img
                  ...
                  alt="Search Icon"
                  className="h-8 w-6 object-contain mx-1"
                />
              </button>
            </div>
          </div>
            ...
            <div className="relative w-[95%]" ref={dropdownRef}>
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <svg
                    className="h-6 w-6 text-monochrome-600 object-contain"
              ...
              <div className={`absolute left-0 w-full mt-1 bg-monochrome-50 rounded-md shadow-lg ${

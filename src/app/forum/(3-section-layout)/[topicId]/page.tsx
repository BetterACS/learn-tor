    ...
    <div className="w-full h-full">
      <div className="flex flex-col p-4 gap-2">
        ...
        <div className="flex flex-col gap-2">
          <div className="text-headline-4">{data.title}</div>
          {/* <div className="text-body-large">{data.body}</div> */}
          <div className="h-[30rem] w-full">
            <img src={data.img} className="w-full h-full object-cover"/>
          </div>
          <div className="flex gap-2">
            <button type="button" name="like" onClick={handleClick} className="text-button">
              Like
            </button>
            <button type="button" name="save" onClick={handleClick} className="text-button">
              Save
            </button>
            <button type="button" name="share" onClick={handleClick} className="text-button">
              Share
            </button>
          </div>
        </div>

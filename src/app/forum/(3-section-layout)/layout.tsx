...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  //     <div className={`fixed top-0 transition-all duration-200 ${isFullyLoaded ? 'opacity-0 size-0' : 'opacity-100 size-full'}`}>
  //       <LoadingCircle />
  //     </div>
